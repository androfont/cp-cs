...
class P05
{
    ...
    internal static void Run()
    {
        ...
        output.WriteLine($"Nice count: {niceCount}");
        output.WriteLine($"Nice count 2: {niceCount2}");
        output.Flush();
    }
    ...
    static bool IsNice(string input)
    {
        ...
        foreach (char c in input)
        {
            ...
            if ((lastChar == 'a' && c == 'b') || (lastChar == 'c' && c == 'd') || (lastChar == 'p' && c == 'q') || (lastChar == 'x' && c == 'y'))
            {
                return false;
            }
            lastChar = c;
    ...
    static bool isNiceV2(string input)
    {
        bool HasRepeatWithOneInMiddle(string input)
        {
        ...
        bool HasSubstringOf2Repeated(string input)
        {
            for (int i = 0; i < input.Length - 3; i++)
            {
                ...
                {
                    if (subString == input.Substring(j, 2))
                    {
                        return true;
                    }
                }
        ...
        return HasRepeatWithOneInMiddle(input) && HasSubstringOf2Repeated(input);
    }

    internal static void GenerateData()
    {
        Console.Write(@"rthkunfaakmwmush
qxlnvjguikqcyfzt
sleaoasjspnjctqt
lactpmehuhmzwfjl
bvggvrdgjcspkkyj
